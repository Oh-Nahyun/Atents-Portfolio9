...
public class EnemySpawner : MonoBehaviour
{
    ...
    Vector3 GetRandomSpawnPosition(bool init = false)
    {
        ...
        do
        {
            ...
            int index = UnityEngine.Random.Range(0, mazeWidth * mazeHeight);    // 미로 밖은 선택되지 않게 하기
            x = index / mazeWidth;
            y = index % mazeHeight;
            ...
            if (limit < 1)                                          // 최대 100번만 시도하기
                ...
                && y < playerPosition.y + halfSize && y > playerPosition.y - halfSize));
