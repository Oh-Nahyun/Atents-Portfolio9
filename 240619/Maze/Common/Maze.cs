...
public class Maze
{
    ...
    /// <param name="seed">랜덤용 시드 (-1이 아니면 지정된 시드 적용 (-1이면 매번 랜덤한 시드 적용))</param>
    ...
    /// <summary>
    /// 각 알고리즘별로 override해야하는 함수
    /// (미로 생성 알고리즘 실행)
    /// </summary>
    protected virtual void OnSpecificAlgorithmExcute()
    {
        // cell을 생성하고, 알고리즘 결과에 맞게 세팅 (cells 안을 생성된 결과에 맞게 세팅)
    }
    ...
    /// <summary>
    /// 특정 그리드 좌표의 셀을 리턴해주는 함수
    /// </summary>
    /// <param name="x">셀의 그리드 x위치</param>
    /// <param name="y">셀의 그리드 y위치</param>
