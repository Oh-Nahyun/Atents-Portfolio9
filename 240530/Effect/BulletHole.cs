...
public class BulletHole : RecycleObject
{
    ...
    private void Awake()
    {
        ...
        duration = effect.GetFloat(DurationID) + durationRange; // 원래 (duration +- durationRange)가 실제 범위이기 때문
    }
    ...
    internal void Initialize(Vector3 position, Vector3 normal, Vector3 reflect)
    {
